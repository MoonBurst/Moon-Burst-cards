...
function s.initial_effect(c)
    --Add an "Enchantress" Spell/Trap card
...
function s.filter(c)
	return c:IsSetCard(0x1B36) and c:IsType(TYPE_SPELL+TYPE_TRAP) and c:IsAbleToHand()
end
...
function s.filter2(c)
	return c:IsFaceup() and c:IsSetCard(0x1B36)
end
...
function s.thfilter(c)
	return c:IsSetCard(0x1B36) and c:IsType(TYPE_MONSTER) and c:IsAbleToHand() and not c:IsCode(id)
end
