...
function s.atktg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	Duel.IsExistingTarget(s.atkstealfilter,tp,LOCATION_MZONE,0,1,nil,e,tp) and
	...
	local g2=Duel.SelectTarget(tp,s.atkstealfilter,tp,LOCATION_MZONE,0,1,1,g1:GetFirst())
end
...
function s.destg2(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc~=c and chkc:IsLocation(LOCATION_ONFIELD) and chkc:IsControler(1-tp) and s.desfilter2(chkc) end
...
function s.swaptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return (chkc:IsLocation(LOCATION_PZONE) and chkc:IsControler(tp) and s.swapatkstealfilter(chkc,e,tp))
	...
	and Duel.IsExistingMatchingCard(s.swapatkstealfilter,tp,LOCATION_PZONE,0,1,nil,e,tp) end
...
function s.swapop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,s.swapatkstealfilter,tp,LOCATION_PZONE,0,1,1,nil,e,tp)
