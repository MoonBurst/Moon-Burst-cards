...
function s.initial_effect(c)
	...
	--Roll a Dice to Gain ATK points
...
function s.thfilter(c)
	return c:IsSetCard(0x35A) and c:IsType(TYPE_MONSTER) and c:IsAbleToHand()
end
...
function s.filter(c)
	return c:IsSetCard(0x35A) and c:IsType(TYPE_PENDULUM) and c:IsType(TYPE_MONSTER)
end
...
function s.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) and tc:IsFaceup() then
	    ...
	    e1:SetCountLimit(1,id+950)
	    e1:SetTarget(s.dictarget)
	    e1:SetOperation(s.dicoperation)
	    tc:RegisterEffect(e1)
	end
end


function s.dictarget(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
	Duel.SetOperationInfo(0,CATEGORY_DICE,nil,0,tp,1)
end
function s.dicoperation(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
