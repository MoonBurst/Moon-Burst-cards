...
function s.initial_effect(c)
	...
	--Inflict 200 points for each card on their field
	local e6=e5:Clone()
...
function s.thfilter(c)
	return c:IsSetCard(0x35A) and c:IsType(TYPE_MONSTER) and c:IsAbleToHand() and c:IsLevelBelow(4) and not c:IsCode(id)--c:IsFaceup() 
end
...
function s.damop2(e,tp,eg,ep,ev,re,r,rp)
	local p=Duel.GetChainInfo(0,CHAININFO_TARGET_PLAYER)
	Duel.Damage(p,Duel.GetFieldGroupCount(p,LOCATION_ONFIELD,0)*200,REASON_EFFECT)
end
